...
Most of these come down to network reality or how spotify serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

spotify rate-limits like any public site. spot already paces
...
Where a surface is gated, spot reads a cookie or token you supply
...
`spot`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what spot actually did
