...
// HTTP behaviour is covered in spotify_test.go.
...
func TestHostWiring(t *testing.T) {
	...
	if want := "spotify://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("spotify", "about")
	if err != nil || got.String() != "spotify://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want spotify://page/about", got.String(), err)
	}
}
